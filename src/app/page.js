...
function Home() {
    return (
        <main>
            ...
            <p>
                Python is a high-level, interpreted programming language. In Python, you don't need to specify the data
                type of a variable when you declare it. Python automatically determines the data type based on the value
                you assign.
            </p>
            ...
            <p>Python has standard control flow structures like if statements, for and while loops.</p>
            ...
            <p>
                In Python, you can define your own functions using the def keyword. Python also has built-in data
